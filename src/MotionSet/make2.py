...
#   <   >.make(Speed array, Position Matrix(x,y,z))
    Position = [
        [x*math.sin(math.radians(0)), y*math.cos(math.radians(0)), z0],
        [x*math.sin(math.radians(0)), y*math.cos(math.radians(0))-30, z0],
        [x*math.sin(math.radians(-45)), y*math.cos(math.radians(-45)), z0],
    ...
    Position = [
        [x*math.sin(math.radians(0))+70, y*math.cos(math.radians(0)), z0+5],
        [x*math.sin(math.radians(0))+70, y*math.cos(math.radians(0))-30, z0+5],
        [x*math.sin(math.radians(-45))+70, y*math.cos(math.radians(-45)), z0+5]
    ]
    Ahead0.make(SpeedHigh, Position)

    Position = [
        [x*math.sin(math.radians(0))+70, y*math.cos(math.radians(0)), z0-10],
        [x*math.sin(math.radians(0))+70, y*math.cos(math.radians(0))-30, z0-10],
        [x*math.sin(math.radians(-45))+70, y*math.cos(math.radians(-45)), z0-10]
    ]
    DownRight.make(SpeedHigh, Position)

    Position = [
        [x*math.sin(math.radians(0)), y*math.cos(math.radians(0)), z0-10],
        [x*math.sin(math.radians(0)), y*math.cos(math.radians(0))-30, z0-10],
        [x*math.sin(math.radians(-45)), y*math.cos(math.radians(-45)), z0-10],
